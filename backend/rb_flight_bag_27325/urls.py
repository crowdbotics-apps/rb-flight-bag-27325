"""rb_flight_bag_27325 URL Configuration
...
admin.site.site_header = "RB Flight Bag"
admin.site.site_title = "RB Flight Bag Admin Portal"
admin.site.index_title = "RB Flight Bag Admin"

# swagger
api_info = openapi.Info(
    title="RB Flight Bag API",
    default_version="v1",
    description="API documentation for RB Flight Bag App",
)
